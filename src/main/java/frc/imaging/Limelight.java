...
public class Limelight {
    ...
    public LimelightTarget getTargetInfo() {
        ...
        if (currentTarget == LimelightTargetType.POWER_PORT) {
            ...
            desiredTarget.setX(sensorIn.getDriveXPos() + getVisionTargetDistance() * 
                                Math.cos(getTargetX() + sensorIn.getGyroAngle()));

            desiredTarget.setY(sensorIn.getDriveYPos() + getVisionTargetDistance() *
                                Math.sin(getTargetX() + sensorIn.getGyroAngle()));
